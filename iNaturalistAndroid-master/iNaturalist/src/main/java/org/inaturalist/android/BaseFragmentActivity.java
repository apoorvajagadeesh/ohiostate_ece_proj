...
public class BaseFragmentActivity extends SherlockFragmentActivity {
    ...
    public void onDrawerCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.HONEYCOMB) {
            ...
            ((ImageView)findViewById(R.id.menu_cloud_icon)).setAlpha(0.54f);
        }
	...
	private void buildSideMenu() {
        ...
        findViewById(R.id.menu_cloud).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityIfNew(new Intent(BaseFragmentActivity.this, CloudActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
            }
        });
        ...
        if (CloudActivity.class.getName().equals(this.getClass().getName())) {
            findViewById(R.id.menu_cloud).setBackgroundColor(getResources().getColor(R.color.side_menu_item_bg_current));
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.HONEYCOMB) {
                ((ImageView) findViewById(R.id.menu_cloud_icon)).setAlpha(1.0f);
            }
        }
    }
